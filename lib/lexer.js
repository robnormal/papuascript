...
var JS_KEYWORDS, PAPUA_KEYWORDS, RESERVED, STRICT_PROSCRIBED, JS_FORBIDDEN,
		...
		UNARY_ASSIGN, PAPUA_OPS, TO_EOL, ASSIGN, FUNC_NAME, REG_TEXT_IDENT
		;
...
FUNC_NAME  = new RegExp('^@' + REG_TEXT_IDENT);
...
Lexer.prototype = {
  ...
  // Generate a newline token. Consecutive newlines get merged together.
	...
	functionName: function() {
		var match;
		if (! (match = FUNC_NAME.exec(this.chunk))) return 0;
		this.token('FN_NAME', match[0].slice(1));
